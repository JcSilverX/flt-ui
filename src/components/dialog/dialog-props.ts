...
type DialogProps = {
  ...
  /**
   * a unique identifier used for managing multiple dialogs.
   * */
  dialogKey: string;
  /**
   *  Required for precise control over dialog instances, id facilitates actions such as opening, closing, or updating specific dialogs
   */
  id: string;
  /**
